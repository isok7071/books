...
use app\modules\common\models\Bookgenres;
use app\modules\common\models\BookgenresSearch;
...
class BookgenresController extends Controller
{
    ...
    {
        $searchModel = new BookgenresSearch();
    ...
    {
        if (($model = Bookgenres::findOne($id)) !== null) {
            return $model;
        }
